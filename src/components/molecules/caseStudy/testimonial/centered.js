...
const Centered = ({
  ...
  <div className="testimonialWrapper_comma">
    <Link href="#">
      <img src={partnerLogo.file.url} className="img_fluid" alt="" style={{ width: '100px' }} />
    </Link>
    <h3 className="testimonialTitle">{partnerSuccess}</h3>
      <p className="testimonialContent" dangerouslySetInnerHTML={{ __html: partnerTestimonial }} />
