  ...
  <div className="card card_iconBg">
    <a href="#">
      <div className="card_body">
        <h5 className="card_title">WIDGETS</h5>
        <p className="card_text">Having trouble managing location data and reviews at scale?</p>
      </div>
      <div className="card_footer">
        <span className="btn_arrow linkText linkText_span">LEARN MORE<svg width="15px" height="18px"
