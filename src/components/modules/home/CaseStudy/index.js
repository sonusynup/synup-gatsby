  ...
  <section class="section_testimonial">
    <div class="container">
      <div class="blockWrapper">
        <div class="testimonialWrapper_outline">
          <div class="testimonialAuthorShadeimg">
            <div class="overlay_content">
              <div class="testimonial_overlay blue_overlay"></div>
              <figure>
                <img src="images/svg/testi-icon.svg" class="img_fluid" alt="" />
              </figure>
            </div>
          </div>
            <p class="testimonialContentOutline">
              "I was using Yext and switched to Synup.
          ...
          <div class="testimonial_wrapperCard">
              ...
              <button class="btn btn_outlineTransparent  btn_arrow">
                  <span class="btn_textSpan">READ MORE<svg width="15px" height="19px" viewBox="0 0 15 19"
