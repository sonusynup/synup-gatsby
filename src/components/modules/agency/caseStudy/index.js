  ...
  <div class="container">
      <div class="blockWrapper">
          <div class="testimonialWrapper">
              <p class="testimonialContent">"I was using Yext and switched to Synup. The services and
                  ...
                  to other competitors and their cost is much cheaper."</p>
              <div class="testimonialAuthor">
                  ...
                  <div class="testimonialAuthor_details">
                      ...
                      <p class="testimonialAuthor_position">CEO, RAWA Law Group APC &amp; SmartCPA</p>
                  </div>
              </div>
          </div>
          <div class="testimonial_wrapperCard">
              <div class="va_list">
                  <div class="va_set">
                      ...
                      <p class="va_text">increased client leads by <span class="primary_text">200%</span></p>
                  </div>
                  <div class="va_set">
                      <a href="#">
                          <img src="images/svg/v-icon.svg" class="img_fluid" alt="" />
              ...
              <button class="btn btn_outlineTransparent  btn_arrow">
                  <span class="btn_textSpan">LEARN MORE<svg width="15px" height="19px" viewBox="0 0 15 19" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns xlink="http://www.w3.org/1999/xlink">
                          <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <g id="UI/Components/button/SecondaryBig/hover" transform="translate(-119.000000, -18.000000)" fill="#4865FF">
