...
const contentHoverActionImage = () => (
  <span className="ebook-downloadlink btn_arrow linkText_span">download<svg width="15px"
          height="18px" viewBox="0 0 15 18" version="1.1" xmlns="http://www.w3.org/2000/svg"
