	...
	const CloseIcon = () => {
		return(
			...
			<svg xmlns="http://www.w3.org/2000/svg" 
				...
				viewBox="0 0 469.785 469.785" style={{enableBackground:"new 0 0 469.785 469.785"}}
				xml space="preserve" 
				width="12px" 
				height="12px" 
				className="">
			...
			<g>
				<g>
					...
					data-original="#DD2E44" className="active-path" data-old_color="#ffffff" fill="#ffffff"/>
				</g>
			</g>
			</g>
		</g> 
